...
profile("althaf", 9999999999, 95) # unexpected output
...
# profile(name = "althaf", mark=99, phone=9999999999) # Error
# profile(9999999999,name= "pavan", mark=99) # error
profile("althaf",mark=98,phone=9876543210)
# * Default args
